...
سیستم مدیریت پروژه و صدور فاکتور برای **تیم برندینگ بالتازار** — یک وب‌اپلیکیشن Flask با رابط کاربری فارسی (RTL) برای مدیریت خدمات، پلن‌ها، مشتریان و سفارش‌ها و تولید خودکار فاکتور PDF.
